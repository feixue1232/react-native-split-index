...
function defineModuleCode(moduleName, code, name) {let verboseName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';let dev = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  return [
  `__d(/* ${verboseName} */`,
